...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" href="{{ url.getBaseUri() }}css/shariftube.min.css?ver=1446962666109">
    </head>
    <body>
        ...
        <script defer src="{{ url.getBaseUri() }}js/shariftube.min.js?ver=1446962666109"></script>
    </body>
</html>