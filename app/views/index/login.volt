        ...
        <div class="form-group clearfix checkbox-control">
            <div id="policy-content">
                <p><span class="close"><i class="fa fa-times"></i></span
                    با استفاده از سرویس اختصاصی شریف تیوب، متعهد می شوم که تمامی ویدیو های دانلود شده توسط بنده در جهت اهداف آکادمیک، تحقیقات علمی و یا سایر اهداف آموزشی است و هرگونه فعالتی که شمال گزینه های مذکور نباشد، به شریف تیوب این اجزه را می دهد که اطلاعات بنده را در اختیار مراجع مربوط قرار دهد.<br/>
                    هم چنین پس از طی مراحل خرید بنده در این سرویس در صورت یکه به هر دلیلی سرویس اختصاصی شریف تیوب قادر به ادامه ی ارایه سرویس نیاشد، هیچ تعهد و مسیولیتی در قبال بازگشت وجه پرداختی از سوی سرویس شریف تیوب به کاربر مورد نظر پذیرفته نیست. در قبال موارد مذکور، سرویس شریف تیوب نیز متعهد می شود در صورت بروز هرگونه مشکل که نهایتا منجر به عدم ادامه ی ارایه سرویس فعلی شود، حداکثر یک ماه قبل از اتمام ارایه سرویس، کاربران محترم را از این رخداد باخبر نماید.<br/>
                    با تشکر از زمان با ارزش شما کار بر محترم<br/>
