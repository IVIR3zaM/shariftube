{{ flash.output() }}
<form class="params" action="{{ url.get(['for':'search']) }}" method="get">
    <input data-index="0" type="hidden" name="start" value="0">
    <label for="q">عبارت</label>
    <input data-index="5" id="q" type="text" size="50" name="q" value="{{ q|e }}">
    <input type="submit" value="جست و جو"><br>
    <select data-index="1" name="dur">
    ...
    <select data-index="4" name="website">
